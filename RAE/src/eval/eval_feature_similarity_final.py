...
def main():
    ...
    eval_dir = os.path.join(args.results_dir, f"{Path(args.ckpt).stem}_full_kernel{args.kernel_size}_view{args.num_views}")
    ...
    vis_depth_dir, vis_pose_dir, vis_feature_sim, vis_pose_metric = os.path.join(eval_dir, "depth_vis"), os.path.join(eval_dir, "pose_vis"), os.path.join(eval_dir, "feature_sim"), os.path.join(eval_dir, "pose_metric")
    os.makedirs(vis_depth_dir, exist_ok=True); os.makedirs(vis_pose_dir, exist_ok=True); os.makedirs(vis_feature_sim, exist_ok=True); os.makedirs(vis_pose_metric, exist_ok=True)
