...
class HypersimDataset(Dataset):
    def __init__(self, clean_img_paths: str, annotation_path: str = None, mode: str = 'train', num_eval_img: int = 100, max_view: int = 8, kernel_size: int = 100, view_sel: dict = None):
        self.mode = mode
