...
def generate_run_id(exp_name):
    unique_name = exp_name + str(time())
    return str(int(hashlib.sha256(unique_name.encode('utf-8')).hexdigest(), 16) % 10 ** 8)

def initialize(args, entity, exp_name, project_name, key=None):
